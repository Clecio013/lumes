...
export function HeaderScroll({ whatsappUrl }: HeaderScrollProps) {
  ...
  const { trackHeaderVisible, trackCTAClick } = useTracking();
        ...
        {isVisible && (
          ...
          <div className="max-w-7xl mx-auto px-3 sm:px-6 py-3 sm:py-4 flex items-center justify-between gap-2 sm:gap-4 md:gap-8">
            ...
            <Button
              ...
              onClick={() => {
                trackCTAClick("header", "Agende sua consulta", "schedule");
                window.open(whatsappUrl || siteConfig.whatsapp.url, "_blank");
              }}
            >
